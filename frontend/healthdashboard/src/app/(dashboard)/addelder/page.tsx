...
const FormSchema = z.object({
  ...
  caregiverName: z.string().min(2, {
    message: "Caregiver name must be included.",
  }),
});
...
export default function InputForm() {
  ...
  return (
    <div className="flex justify-center items-center my-8">
      <Card>
        <CardHeader>
          <CardTitle>Register Elder</CardTitle>
          <CardDescription>
            Enter your elders details to register.
          </CardDescription>
        </CardHeader>
          ...
          <Form {...form}>
            ...
            >
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Elder Name</FormLabel>
                    <FormControl>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="caregiver name" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
